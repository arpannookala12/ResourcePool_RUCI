...
ind <- read.csv("D:\\DOWNLOADS_FOR_D_DRIVE_REAL_TIME\\HPSDATA\\HPS_Phase4Cycle01_PUF_CSV\\hps_04_00_01_puf.csv")
# Display the data
...
con_age <- read.csv("D:\\Desktop_New\\RUCI_LAB\\con_age.csv")
con_sex <- read.csv("D:\\Desktop_New\\RUCI_LAB\\con_sex.csv")
con_edu <- read.csv("D:\\Desktop_New\\RUCI_LAB\\con_edu.csv")
